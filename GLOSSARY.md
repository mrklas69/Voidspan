...
### Premise
Přicházejí kolonisté z mateřské civilizace (Země / odjinud — prequel otevřený). Toto je **nový svět s novými pravidly** — žádné dědictví minulosti, instituce se budují od nuly. Noví hráči = další vlny kolonistů (onboarding narativně ukotven, viz *Capsule* a *Act -1* v SCENARIO).
...
### Invitation (Pozvánka)
Marketing/narativní vstup: welcome stránka, email, reklama. Obsahuje motivační výzvu a **fiktivní bankovní účet** (narativní rekvizita, žádná reálná transakce — viz SCENARIO sekce 11.2).
...
### Revival
Rozhodnutí kolonie kapsli přijmout a hráče oživit. Zahajuje Act 0.
...
Cesta vzhůru mezi tiers je **ústavně garantovaná** (Tenet T3).
...
Jeden běh hry od Act -1 do některého ze zakončení. Po *Reset* zakončení může vzniknout nová iterace se stejnou kolonií ve druhé generaci.
...
|---|---|---|
| `CONST_BELT_LENGTH` | Obvod prstence v cells | TBD (pro prototyp 500–2000) |
