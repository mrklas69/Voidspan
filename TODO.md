...
- [ ] **Inteligentní postranní dokování otevřených panelů** — Event Log a Info Panel dnes kotví fixně v rozích, překrývají BELT. Chytré dokování:
  - Panel se otevře → BELT se posune, aby zůstal plně viditelný.
  - Auto-side: panel se dokuje tam, kde je víc místa (nemusí být fix pravý/levý).
  - Při otevření obou panelů: BELT se centruje mezi nimi.
  - Axiom: **BELT je vždy viditelný**; panel ustupuje, ne naopak.
