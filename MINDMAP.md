...
Verze: **v1.0** (2026-04-12, konec sezení 4 — SPECIFICATION.md v0.1 DRAFT založena; přípravná fáze běží dál)
...
│   ├── 3.1 Prostor a čas                              [◐]
│   │    (topologie Belt/Cell/Hub + real-time + entropie)
│   ├── 3.2 Postava hráče                              [◐]
│   │    (STATUS+RANK+SKILL pro POC; brains-driven)
│   └── 3.3 Oblasti hry                                [◐]
...
│   ├── 4.3 Network Arc (A) — síť beltů (R1)          [○]
...
Bod 1 **uzavřen**. Následuje **bagr mechaniky**:

**Pořadí:** 3.1 Q7 (kdo je hráč) → 3.2 Q9 (atomická akce) → 3.3 Q11 (motivační smyčka) → **Q17 (rozsah P1 POC)**.

Primárním kritériem rozhodnutí v 3.1–3.3 je teď **„co dává smysl pro POC hraný blízkými"**, ne „co dává smysl pro long-term teenager komunitu". Aspiration stranou, POC napřed.

Pak teprve: 3.8 penal colony, 4.4 multi-colony frakce, 5.1 World Browser jako competition view, art pipeline (6.4), moderace (6.5).
